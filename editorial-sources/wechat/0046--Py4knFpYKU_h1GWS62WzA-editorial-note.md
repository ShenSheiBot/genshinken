# 【译文】杉井光：轻小说无评论家，故无文学奖：微信归档编辑记录

- 2026-08-17 责任字段复核：原页编辑署名已进入结构化 `editor`／`editors` 元数据，读者正文不重复责任行；本条取代下方早期“正文保留编辑署名”或“schema 无编辑字段”的处理说明。

- sourceId：`0046--Py4knFpYKU_h1GWS62WzA`；source URL：`https://mp.weixin.qq.com/s/-Py4knFpYKU_h1GWS62WzA`。
- raw.html SHA-256：`cb3038be8f060d50a517db6681b21eb5d78fef49d18a6481f240e6c512b1e01b`；body.html SHA-256：`d43bd6ba30c96b03a3b19d90b738df9e04c398a126c4f9da2e21a5d3063fac56`；顶层 DOM block `84`（正文扫描覆盖 1–84）。
...
- 许可/署名/citation：front matter 保留 CC BY-NC-SA 4.0；杉井光为原作者、幽灵在都灵为译者；citation 为微信 `blogPost`，原文 Kakuyomu URL 置于 `extra`，未伪造书籍或期刊出处。
