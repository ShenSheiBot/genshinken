...
- raw 的居中粗体“注释”由 GFM 脚注渲染器统一生成的可见“注释”区标题承接，不在 Markdown 再造重复标题。原图逐图复核为浅绿色长发人物，修正原先“金发”alt。
- metadata description 是平台截短摘要，不作为正文权威；完整文章身份由 raw 首段和书籍章节记录承接。旧 GUI ledger 的 body/image 计数早于当前 exact-inner-html 刷新且已失效，本次只依当前 raw/body/metadata/images 哈希与 preservation contract 验收，不拿错配的 row0064 截图作本文证据。

- Canonical book mapping: 本条正文已并入《直面资本与帝国：重思京都学派哲学》唯一 book host /books/confronting-capital-and-empire 的章节锚点 `#chapter-01-philosophy-answerability`；原微信 canonical URL 仍作为本章来源证据，独立公开稿已移除。
