...
- 结构计数：raw `#js_content` 有 59 个直接子元素；抽取为 51 个非空文本事件与 5 个图片事件，preservation matcher 按长度阈值登记 46 个来源文本块。直接核对 `<img>` `data-src` 与 DOM 事件顺序，正文图片 placement 1–5 均保留。
- 责任链：原作者/页面作者 KAZUMI NAGAIKE、TOMOKO AOYAMA；译者 Surveiller；校对 郁远集；编辑 夜深人静。
- 标题与引文：8 个粗体分节题全部恢复为 H2；两段在原文中以加粗、缩进独立呈现的引文恢复为 blockquote。
- 图片与图题：5 张书封均逐图目检并独立恢复为 figure。原文没有文字图题，公开稿依据画面可读书名及邻接论述补入说明；placement 1 实为栗本薰《終わりのないラヴソング1》，此前误标为森茉莉《恋人们的森林》，现已纠正。placement 2–5 分别为《风与木之诗》第14卷、《物语消费论》、《BL漫画的表现史》与《恋人们的森林》中文译本。
- 脚注与链接：raw 正文未发现编号脚注调用、定义或正文链接。
...
- 下架稿补充证据：2026-08-29 收到的 DOCX（SHA-256 `4feca08b3539dfa22db867f04e59c9c1bf9fed479afc9d5b22a6ee873767bd01`）与本 canonical 正文规范化匹配率为 99.71%，五张正文图片逐项对应，因此不建立第二页面。DOCX 另含一段有关 2010 年网站封禁与 32 名女性作者被捕的文字，并将“天地如逆旅”列入校对责任；这两项均不见于保存完好的 canonical `raw.html`，故仅作为补充来源差异记录，不覆盖已发布正文与责任链。
