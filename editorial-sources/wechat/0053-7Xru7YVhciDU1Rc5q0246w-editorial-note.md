# 对EVA的审视：神罚与自由的主体(上)：微信归档编辑记录

- 2026-08-17 责任字段复核：原页编辑署名已进入结构化 `editor`／`editors` 元数据，读者正文不重复责任行；本条取代下方早期“正文保留编辑署名”或“schema 无编辑字段”的处理说明。

- sourceId：`0053-7Xru7YVhciDU1Rc5q0246w`；source URL：`https://mp.weixin.qq.com/s/7Xru7YVhciDU1Rc5q0246w`。
- raw.html SHA-256：`fab51e290984b0675a1826ad0b5bb01b36ee4c9433a5a8f70bee1cef936fc634`；body.html SHA-256：`964ab56ef76f9b06f5e209d6b64f6695e8edf8e82d99adf56cc5d7bf806bb9a3`；顶层 DOM block `135`（正文扫描覆盖 1–135）。
...
- canonical 合并关系：与 `0054--DLlcdtQYm6QfGpbiRl3tw` 同日（公开稿均为 2025-11-09）、同作者“霜路组合”、同题《对EVA的审视：神罚与自由的主体》，本篇标题标为“上”，后篇标为“下”；本篇正文作者注号 `1–14`，后篇从 `15–19` 接续，raw 图片 placement 分别为21与58，合并稿共79个 placement。两 source 已建立为 complete 两章文库，单一 canonical 按上→下完整收录；总标题不重复上下篇后缀，章节锚点保留分篇身份。上篇末“未完”属于分刊状态，合订后由章节边界取代。
- raw 顶部 `//` 与阅读时间是表现层提示，未进入公开正文；作者“霜路组合（寒霜血蝶、路觉）”、排版与编辑“路觉”已保留在正文和 citation 责任链。license 映射为 `CC BY-NC-SA 4.0`；知乎原载地址与上下篇微信地址均保留在 citation/书目证据中。
