...
- 原文：週末批评，2024-09-20；作者 てらまっと；译者、校对：中割Production。正文 21 个图片 placement，21 个 unique body 资产，历史照片与电影画面按原序保留。
- 删除版权/投稿平台通用尾部；正文未保留原平台的“注释从略”替代品。无脚注调用或定义；许可：CC BY-NC-SA 4.0。

## Preservation omission audit (archiveSequence 0025)

- block 0 的《週末批评》出处与 2024-09-20 日期已写入 citation provenance；blocks 2、3 的译者/校对责任链已结构化记录；block 5 的 CC/投稿说明按平台噪声删除。上述均不是正文段落，未从公开正文复制平台出处行。21 个图片 placement、图题、链接和顺序均已按 raw DOM 保留。
