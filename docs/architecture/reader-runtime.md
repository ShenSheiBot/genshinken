...
- 移动端页眉保留首页品牌图标、文章目录、繁简与阅读习惯入口；注释和文献共用一个焦点受控的底部 dialog。阅读习惯面板在任一断点都作为独立右侧抽屉水平平移进出。页眉的主题、繁简与阅读习惯三个按钮在面板开合期间保持同一 DOM 节点与几何位置；面板标题行另设关闭按钮，关闭后焦点回到页眉中稳定存在的阅读习惯入口。
