...
groups:
  - id: event-opening
    number: "01"
    title: 活动启幕
    summary: 年度征文的主题、赛制、评选办法与投稿规则。
    items:
      - type: post
        ref: rags-drum-2020-call-for-papers
        editorialNote: 公布前夜祭与后夜祭两阶段流程、评委、奖励及投稿办法。
  - id: selected-essays
    number: "02"
    title: 入选评论
  ...
  - id: event-closing
    number: "03"
    title: 前夜祭补录与年度结果
    summary: 一篇正文明确标注的前夜祭合格稿，以及公布年度名单与奖项的结果页。
    items:
      - type: post
        ref: bouyuu-toukaidou-chonin-culture-ukiyo-e
        editorialNote: 正文明确自称前夜祭合格稿，讨论《卯酉东海道》中的町人文化与浮世绘。
      - type: post
        ref: rags-drum-2020-final-results
        editorialNote: 公布年度入选名单、评选结论与活动收束。
---

拾荒战略Rags Drum 2020采用前夜祭与后夜祭两阶段赛制。本专题以公告为起点，汇集结果页列出的十篇年度入选评论，并保留一篇正文明确标注的前夜祭合格稿，最后以年度评选结果收束。

《真实与包容的生命意志：〈卯酉东海道〉中的町人文化与浮世绘》没有出现在最终结果页列出的十篇名单中，但原文直接说明其前夜祭合格身份，因此单列展示，不改写最终名单。
