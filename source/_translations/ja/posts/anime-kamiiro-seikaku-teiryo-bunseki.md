...
[author-bio] 「私たちは素晴らしいものを守ることに多くの時間を費やす。一つひとつのアイデアに触れ、そのアイデアが触れた人生を変えるまで」
...
[fig] 図1：髪色―萌え属性の共起ネットワーク（TOP1アルゴリズム）。
...
[fig] 図3：性格に対応する髪色のTF-IDF値、上位5（TF-IDF（T1）－TF-IDF（T2）＞0.05）。
